...
- **Quản lý Cài đặt (`/settings`)**: Tùy chỉnh trực tiếp cơ sở tri thức FAQ, danh sách Nhóm và **Cấu hình Văn phong & Xưng hô AI** (Tên đơn vị, xưng hô Nam/Nữ/Mặc định, môi trường hoạt động) ngay trên giao diện Web mà không cần sửa file `.env`.
